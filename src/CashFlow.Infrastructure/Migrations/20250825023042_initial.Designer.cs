...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CashFlow.Domain.Account.AccountBalanceDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CashFlow.Domain.User.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CashFlow.Domain.Account.AccountEntity", b =>
                {
                    ...
                    b.HasOne("CashFlow.Domain.User.UserEntity", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CashFlow.Domain.User.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
